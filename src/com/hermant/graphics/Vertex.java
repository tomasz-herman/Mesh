...
public class Vertex {
    ...
    public void transform(Matrix4f MVP, Viewport viewport){
        ...
        transformed.set((((transformed.x / transformed.w + 1) / 2) * viewport.right), (((-transformed.y / transformed.w + 1) / 2) * viewport.bottom), transformed.z / transformed.w, 1.0f / transformed.w);
